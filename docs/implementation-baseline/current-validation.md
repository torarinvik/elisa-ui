...
pixel-stable samples, with a recorded median of 34.737 ms and a maximum of
45.643 ms, inside the recorded 40/55 ms policy limits. The tuple is recorded in
