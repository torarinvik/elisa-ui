...
tail-pixel-stable samples, with a recorded median of 12.072 ms and a maximum of
15.303 ms, inside the current 50/80 ms policy limits. The exact source-bundle
