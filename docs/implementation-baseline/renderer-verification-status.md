...
- Off-screen Skia (`0f08a3ca`): 16 iterations, average `819023 ns`, pixel
...
- Public hello showcase workflow: 70 commands, 25 semantic nodes, 19 custom
  ...
  `5105778 ns`, pixel digest `f8cc2ba20c07b5bd`; a fresh process reproduced it.
...
- Million-item Showcase workflow plus Skia tail frame: the latest `0f08a3ca`
  tuple has a recorded median of `19.746 ms` and maximum `24.061 ms`, within
