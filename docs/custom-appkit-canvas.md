...
tooltip eligibility arrives as an already-resolved boolean. Writable slider values
are normalized and accepted by Elisa before Cocoa mirrors the result. Per-element value,
