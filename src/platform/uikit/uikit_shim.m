...
extern int elisa_uikit_accessibility_set_container(size_t viewHandle, size_t handle, size_t container);
extern int64_t elisa_uikit_accessibility_child_count(size_t viewHandle, size_t parentHandle);
extern size_t elisa_uikit_accessibility_child_at(size_t viewHandle, size_t parentHandle, int64_t index);
extern int64_t elisa_uikit_accessibility_child_index_of(size_t viewHandle, size_t parentHandle, size_t elementHandle);
