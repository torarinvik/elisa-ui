...
void elisa_appkit_canvas_frame(size_t context) {
    ...
    size_t sliderElement = elisa_appkit_canvas_accessibility_add(test_window_handle, test_accessibility_handles[0], (size_t)(__bridge void *)@"elisa-ui-7", NSAccessibilitySliderRole, 0,
    ...
    size_t textElement = elisa_appkit_canvas_accessibility_add(test_window_handle, test_accessibility_handles[1], (size_t)(__bridge void *)@"elisa-ui-8", NSAccessibilityTextFieldRole, 0,
    ...
    const char *masked = "••••";
    size_t secureElement = elisa_appkit_canvas_accessibility_add(test_window_handle, test_accessibility_handles[2], (size_t)(__bridge void *)@"elisa-ui-9", NSAccessibilityTextFieldRole, NSAccessibilitySecureTextFieldSubrole,
...
int main(void) {
    ...
    if (require(elisa_appkit_canvas_accessibility_add(
                    opened, 0, 0, NSAccessibilityButtonRole, NULL, 0,
